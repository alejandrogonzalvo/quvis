...
export class QubitGrid {
    ...
    loadNPZData(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield loader.load(url);
    ...
    createQubit(id, x, y) {
        ...
        // Z-axis (vertical)
        const zAxis = new THREE.Mesh(axisGeometry, new THREE.MeshBasicMaterial({ color: 0x888888 }));
        blochSphere.add(zAxis);
        // X-axis (horizontal)
        const xAxis = new THREE.Mesh(axisGeometry, new THREE.MeshBasicMaterial({ color: 0x888888 }));
        xAxis.rotation.z = Math.PI / 2;
        blochSphere.add(xAxis);
        // Y-axis
        const yAxis = new THREE.Mesh(axisGeometry, new THREE.MeshBasicMaterial({ color: 0x888888 }));
        ...
        const stateVector = this.createArrow(new THREE.Vector3(1, 0, 0), this.getStateColor('0'));
