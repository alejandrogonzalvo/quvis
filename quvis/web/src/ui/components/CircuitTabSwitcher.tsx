...
const CircuitTabSwitcher: React.FC<CircuitTabSwitcherProps> = ({
    ...
    const containerStyle: React.CSSProperties = {
        ...
        maxWidth: isExpanded ? (circuits.length > 5 ? "700px" : "90vw") : "200px",
    ...
    const scrollbarStyles = circuits.length > 5 ? `
    ...
    const typeIndicatorStyle = (type: "logical" | "compiled"): React.CSSProperties => ({
        fontSize: "10px",
        fontWeight: 600,
        textTransform: "uppercase",
        letterSpacing: "0.5px",
        color: type === "logical" ? colors.circuit.logical : colors.circuit.compiled,
        backgroundColor: type === "logical" 
    ...
    const formatCircuitInfo = (circuit: CircuitInfo): string => {
        ...
        if (circuit.circuit_type === "compiled" && stats.swap_count !== undefined) {
                ...
                >
                    {circuits.map((circuit, index) => (
                        <button
                            ...
                            onClick={() => !disabled && onCircuitChange(index)}
                            disabled={disabled}
                        >
                            ...
                            <div style={typeIndicatorStyle(circuit.circuit_type)}>
